...
public class ChatScreen {
	...
	public static String endPoint = "id:statusText";
	public static String searchHistory = "id:menu_search";

	public static String createChatRoomButton = "id:fab";
	...
	public static String findFriendTextField = "id:email";
	...
	public static String acessPopUp="xpath://android.widget.TextView[@text='Allow Keanu to access photos, media, and files on your device?']";
	public static String selectAllowedoption="xpath://android.widget.Button[@text='Allow']";
	
	public static String acessRecordingPopUp="xpath://android.widget.TextView[@text='Allow Keanu to take pictures and record video?']";
	public static String allowPermissionBtn="xpath://android.widget.Button[@text='Allow']";
	
	public static String acessAudioPopUp="xpath://android.widget.TextView[@text='Allow Keanu to record audio?']";
	public static String allowAudioBtn="xpath://android.widget.Button[@text='Allow']";
	
	public static String backFromChatRoom="xpath://android.widget.ImageButton[@content-desc='‎‏‎‎‎‎‎‏‎‏‏‏‎‎‎‎‎‏‎‎‏‎‎‎‎‏‏‏‏‏‎‏‏‎‏‏‎‎‎‎‏‏‏‏‏‏‏‎‏‏‏‏‏‎‏‎‎‏‏‎‏‎‎‎‎‎‏‏‏‎‏‎‎‎‎‎‏‏‎‏‏‎‎‏‎‏‎‏‏‏‏‏‎‎Navigate up‎‏‎‎‏‎']";
	...
	public void createChatRoomBySearchingFriend(String friendName, String RoomName) throws Exception {
		appLibrary.clickMobileElement(createChatRoomButton);
	...
	public void archiveChatRooom(String RoomName) throws Exception 
	{
	...
	public ChatScreen createStory(String storyName) throws Exception
	{
		...
		appLibrary.verifyMobileElement(acessPopUp);
		appLibrary.clickMobileElement(selectAllowedoption);
		
		appLibrary.verifyMobileElement(acessRecordingPopUp);
		appLibrary.clickMobileElement(allowPermissionBtn);
		
		appLibrary.verifyMobileElement(acessAudioPopUp);
		appLibrary.clickMobileElement(allowAudioBtn);
	...
	public void takeBacktoChatRoom() throws Exception
	 {
		 appLibrary.clickMobileElement(backFromChatRoom);
	 }
}
