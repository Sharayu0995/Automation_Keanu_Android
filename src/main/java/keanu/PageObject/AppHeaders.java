...
public class AppHeaders {
	...
	public static String chatScreen = "xpath:(//android.widget.ImageView[@index='0'])[1]";
	public static String friendScreen ="xpath:(//android.widget.ImageView[@index='0'])[2]";
	...
	public static String searchEditor = "id:search_src_text";
	...
	public AppHeaders navigateToChat() throws Exception {
		...
		appLibrary.clickMobileElement(chatScreen);
	...
	public AppHeaders navigateToFriends() throws Exception {
		appLibrary.clickMobileElement(friendScreen);
	...
	public AppHeaders searchOption(String searchText) throws Exception {
		appLibrary.clickMobileElement(searchHistory);
